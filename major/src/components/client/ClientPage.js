  ...
  return (
    <div>
      ...
      <div className="col-md-4 border border-1 p-4 mt-5" style={{ backgroundColor: '#fff'}}>
        ...
        <Link to="/Booking">
        <button  type='button' className="btn btn-warning form-control mt-3 mb-3">Book Services</button>
        </Link> 
        <Link to ='/StatusCheck'>
        <button type="button" className="btn btn-warning form-control mt-3 mb-3" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
          ...
          <Link to ='/PreviousHistory'>       
          <button type="button" class="btn btn-warning form-control" >Previous Bookings</button>
          </Link>
